          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="lg:w-1/2 text-left">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                <span className="text-primary">Cattle</span>Manager
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button onClick={() => navigate('/login')} size="lg" className="font-medium">
              ...
              <Card className="w-full max-w-md shadow-lg border-border/50 bg-gradient-to-br from-card to-card/90">
                ...
                <CardContent className="p-4 md:p-6">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="dashboard-stat">
                      <p className="text-sm text-muted-foreground">Ganho de Peso Médio</p>
                      <p className="text-2xl font-bold">1.2 kg/dia</p>
                    </div>
                    <div className="dashboard-stat">
      ...
      <footer className="py-8 px-4 border-t border-border">
        <div className="container mx-auto max-w-6xl text-center">
          <p className="text-muted-foreground">
            © 2025 CattleManager - Sistema de Gestão de Rebanho
          </p>
        </div>
      </footer>
    </div>
